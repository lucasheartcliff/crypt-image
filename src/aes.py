...
class Encryptor:
    ...
    def pad(self, s):
        return s + bytes_to_string(b"\0" * (AES.block_size - len(s) % AES.block_size))
    ...
    def decrypt(self, ciphertext, ):
        ...
        cipher = AES.new(self.key, AES.MODE_CBC, iv)
        plaintext:str = cipher.decrypt(ciphertext[AES.block_size:])
        return bytes_to_string(plaintext.rstrip(b"\0"))
